...
* **0. Run Python file**
  * [0-run](./0-run): Shell script that runs a Python script file saved in the environment variable `$PYFILE`.

* **1. Run inline**
  * [1-run_inline](./1-run_inline): Shell script that runs Python code saved in the environment variable `$PYCODE`.
